...
def graphql_middleware(bottle_app, endpoint_name, graphene_schema):
  bottle_app.route(endpoint_name, 'OPTIONS', execute_introspection_query(graphene_schema))
  bottle_app.route(endpoint_name, 'POST', execute_post_query(graphene_schema))
